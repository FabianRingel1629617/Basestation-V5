...
typedef enum {
    ...
    COMMAND_TYPE_SCRIPT_COMMAND = 127,      // 127
    COMMAND_TYPE_CHANGE_BS_MODE = 128,      // 128  //Ändern des BS-Modus
    COMMAND_TYPE_UPDATE_BS_DATA = 253,      // 253  //BS CMD
    COMMAND_TYPE_REQUEST_BS_DATA = 254,     // 254  //BS CMD
